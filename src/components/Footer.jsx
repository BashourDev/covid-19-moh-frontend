    ...
    <div className="px-4 pt-16 mx-auto w-full sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          <div className="mt-6 lg:max-w-sm">
            <p className="text-sm text-light">
              الموقع الرئيسي لإدارة ومراقبة الأمراض الوبائية في المشافي بحيث
              نقوم بتوفير مكان مركزي للمشافي للتسجيل والبدء بتسجيل الحالات و
              إعداد التقارير بشكل سهل وفعال دون الحاجة إلى القيام بالعملية بشكل
              يدوي
            </p>
          </div>
        </div>
        <div className="space-y-2 text-sm">
          ...
          <div className="flex">
            <p className="mr-1 text-light">هاتف:</p>
            <a
          ...
          <div className="flex">
            <p className="mr-1 text-white">بريد إلكتروني:</p>
            <a
          ...
          {/* <div className="flex">
            <p className="mr-1 text-white">عنوان:</p>
            <a
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        <p className="text-sm text-gray-300">
          © Copyright 2022 COVID-19 Center. All rights reserved.
        </p>
